...
public class AccountControllerExceptionHandler {
    ...
    public ResponseEntity<ResponseException> notFound(MyAccountNotFoundException exception) {
        ResponseException responseException = new ResponseException(exception.getMessage());
